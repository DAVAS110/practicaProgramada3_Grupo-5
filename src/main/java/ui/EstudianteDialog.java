 ...
 * @author maria
 */
public class EstudianteDialog extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EstudianteDialog.class.getName());
